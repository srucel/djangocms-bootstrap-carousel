...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        """
        This is a data migration only, to avoid

            cannot ALTER TABLE "djangocms_bootstrap_carousel_carousel" because it has pending trigger events                    
        """

        # Changing field 'Carousel.height'
        orm.Carousel.objects.filter(height=None).update(height='')

        # Changing field 'Carousel.width'
        orm.Carousel.objects.filter(width=None).update(width='')
