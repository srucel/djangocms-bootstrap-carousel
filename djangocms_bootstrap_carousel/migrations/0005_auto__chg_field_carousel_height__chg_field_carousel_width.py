...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'djangocms_bootstrap_carousel_carousel', 'height', self.gf('django.db.models.fields.CharField')(max_length=16, null=False, default=''))

        # Changing field 'Carousel.width'
        db.alter_column(u'djangocms_bootstrap_carousel_carousel', 'width', self.gf('django.db.models.fields.CharField')(max_length=16, null=False, default=''))
    ...
    models = {
        ...
        'djangocms_bootstrap_carousel.carousel': {
            ...
            'width': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'})
        },
