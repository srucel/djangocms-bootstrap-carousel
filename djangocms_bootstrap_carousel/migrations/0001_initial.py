...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'djangocms_bootstrap_carousel_carousel', (
            ...
            ('indicator', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('djangocms_bootstrap_carousel', ['Carousel'])

        # Adding model 'CarouselItem'
        db.create_table(u'djangocms_bootstrap_carousel_carouselitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('carousel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djangocms_bootstrap_carousel.Carousel'])),
            ...
            ('link', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djangocms_link.Link'], null=True, blank=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True, blank=True)),
        ))
        db.send_create_signal('djangocms_bootstrap_carousel', ['CarouselItem'])


    def backwards(self, orm):
        # Deleting model 'Carousel'
        db.delete_table(u'djangocms_bootstrap_carousel_carousel')

        # Deleting model 'CarouselItem'
        db.delete_table(u'djangocms_bootstrap_carousel_carouselitem')
